...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { cpf: @registration.cpf, grr: @registration.grr, name: @registration.name } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { cpf: @registration.cpf, grr: @registration.grr, name: @registration.name } }
